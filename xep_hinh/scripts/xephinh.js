...
// Tạo mảng 20 dòng 10 cột phần tử
  generateWhiteBoard() {
...
//hàm vẽ giao diện 20 dòng, 10 cột (giao diện game)
  drawBoard() {
...
//Xử lý row đã hoàn thành, tính điểm game
  handleCompleteRows() {
...
// Hàm tạo khối xếp rơi ngãu nhiên
